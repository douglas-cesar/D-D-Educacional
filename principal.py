...
for tabela in c:
  x = ''.join(tabela) # Retira a virgula e paretenses das tuplas
  if nome.lower() == x: #Verifica se o dado que o usuario digitou está igual ao do banco de dados
      ...
      image= r"C:\Users\Deyvid\Desktop\D & D\D-D-Educacional\carinha.png"
      pdf = canvas.Canvas('boletim.pdf') #Criar uma arquivo pdf chamado boletim
      pdf.drawImage(image,10,590)
